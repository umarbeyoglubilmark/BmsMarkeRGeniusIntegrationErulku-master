...
{
    public partial class Frm_Control_Item : DevExpress.XtraEditors.XtraForm
    {
        CONFIG CFG;
        string ViewName = "Bms_XXX_MarkeRGeniusIntegration_Control_Items";
        public Frm_Control_Item(string HEADERNAME)
        {
            InitializeComponent();
