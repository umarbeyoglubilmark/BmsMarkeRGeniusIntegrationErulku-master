...
{
    public partial class Frm_Control_Client : DevExpress.XtraEditors.XtraForm
    {
        CONFIG CFG;
        string ViewName = "Bms_XXX_MarkeRGeniusIntegration_Control_Client";
        public Frm_Control_Client(string HEADERNAME)
        {
            InitializeComponent();
